...
# 아래 네 이름(base64·io·configure_matplotlib_korean_font·_calc_rsi)은 이 파일 안에서
# 쓰이는데 원본에는 import 가 없었다. 그 탓에 quant 라우터의 6개 엔드포인트 중
# 5개가 호출 즉시 NameError 로 500 을 반환했다. 경위는 NOTICE.md 를 참고한다.
import base64
import io
...
try:
    ...
    from indicators import calc_rsi as _calc_rsi  # type: ignore
